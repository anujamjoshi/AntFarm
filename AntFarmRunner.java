...
public class AntFarmRunner
{
	public static void main(String[] args)
	{
        ...
        world.add(new Location(16, 4), new Cake());
        world.add(new Location(9, 18), new QueenAnt());
       // world.add( new Location(8, 0), new QueenAnt());
       world.add(new Location (2,3), new WorkerAnt());
        world.add(new Location (16,1), new WorkerAnt());
        for (int i = 0; i< 30; i++)
